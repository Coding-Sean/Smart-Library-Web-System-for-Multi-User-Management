...
// Fetch book details
$book = $librarianModel->getBookById($book_id);

if (!$book) {
    header('Location: ../Librarian_Dashboard.php?error=' . urlencode('Book not found'));
    exit;
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <header class="dashboard-header">
        <div class="header-content">
            <h1 class="header-title">MyLibrary - Edit Book</h1>
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="dashboard-card">
                    ...
                    <form method="POST" action="../../controller/LibrarianController.php?action=update" class="mt-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="copies" name="copies" 
                                       min="0" value="<?= $book['copies'] ?>" required>
                            </div>
